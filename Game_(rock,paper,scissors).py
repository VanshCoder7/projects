...
print('\n')
Players = input("Hello,\nHow many players want to play (rock, paper, scissors) game? = ")
if (int(Players) <= 0):
    print("Invalid input!")
            ...
            if p2.replace(" ", "").isalpha():
                ...
                if p1_str.replace(" ", "").isalpha():
                    ...
                    if p2_str.replace(" ", "").isalpha():
                        ...
                        print(f"{p2_str} is not valid input! (rock, paper, scissors)?")
                else:
                    print(f"{p1_str} is not valid input! (rock, paper, scissors)?")
            else:
                print(f"Enter {p2} valid input!")
        else:
            print(f"Enter {p1} valid input!")
    else:
                        ...
                        if p2_str.replace(" ", "").isalpha():
                            ...
                            if p3_str.replace(" ", "").isalpha():
                                ...
                                if None in (you1, you2, you3):
                                    ...
                                    # Add game result logic here as needed (you already wrote this)
                            else:
                                print(f"{p3_str} is not valid input! (rock, paper, scissors)")
                        else:
                            print(f"{p2_str} is not valid input! (rock, paper, scissors)")
                    else:
                        print(f"{p1_str} is not valid input! (rock, paper, scissors)")
                else:
                    print(f"Enter {p3} valid input!")
            else:
                print(f"Enter {p2} valid input!")
        else:
            print(f"Enter {p1} valid input!")
