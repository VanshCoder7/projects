...
if (int(Players)<=0):
            ...
            if p2.replace(" ", "").isalpha(): 
                ...
                if p1_str.replace(" ","").isalpha():
                    ...
                    if p2_str.replace(" ","").isalpha():
                        ...
                        print(f"{p2_str} is not vaild input!(rock,paper,scissors?)")

                else:
                    print(f"{p1_str} is not vaild input!(rock,paper,scissors)?")                
        ...
        if p1.replace(" ", "").isalpha():
            ...
            if p2.replace(" ", "").isalpha():
                ...
                if p3.replace(" ", "").isalpha():
                    print('_____(GAME START!)_____')
                    p1_str = input(f'Enter {p1} your choice (rock,paper,scissors)? = ')
                    p1_str = ' '.join(p1.split())
                    if p1_str.replace(" ", "").isalpha():
                        p2_str = input(f'Enter {p2} your choice (rock,paper,scissors)? = ')
                        p2_str = ' '.join(p1_str.split())
                        if p1_str.replace(" ", "").isalpha():
            ...
            # 2
                                ...
                                print(f"{p3_str} is not vaild input!(son,paper,scissors)")        

                        else:
                            print(f"{p2_str} is not vaild input!(son,paper,scissors)")        

                    else:
                        print(f"{p1_str} is not vaild input!(son,paper,scissors)")
    ...
    print(f"This game can't play {Players} players!")